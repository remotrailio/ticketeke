<section class="bg-indigo-600 py-20 text-white">
    <div class="container mx-auto px-4">
        <div class="mx-auto max-w-3xl text-center">
            ...
            {{-- Badge --}}
            <div
                class="mb-6 inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-1.5 text-sm font-medium text-white">
            ...
            {{-- Heading --}}
            <h2 class="mb-4 text-3xl font-bold leading-tight md:text-4xl">
                Ready to Host Your Own Event?
            </h2>

            {{-- Subtitle --}}
            <p class="mb-10 text-xl text-white/90">
                Join organizers across Kenya using Pitisha to reach new audiences,
