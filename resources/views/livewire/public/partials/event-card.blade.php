...
<div class="group flex flex-col overflow-hidden rounded-xl border border-gray-100 bg-white cursor-pointer transition-all duration-300 hover:-translate-y-1 hover:shadow-xl">
    ...
    <div class="p-4 space-y-3">
        <h3 class="line-clamp-2 min-h-[3rem]">{{ $event->title }}</h3>
        <div class="space-y-2">
            <div class="flex items-start gap-2 text-sm text-muted-foreground">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                    stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-calendar w-4 h-4 mt-0.5 flex-shrink-0">
                    <path d="M8 2v4"></path>
                    <path d="M16 2v4"></path>
            ...
            @elseif($event->city)
                <div class="flex items-start gap-2 text-sm text-muted-foreground">
                    <svg xmlns="http://www.w3.org/2000/svg"
                        ...
                        class="lucide lucide-map-pin w-4 h-4 mt-0.5 flex-shrink-0">
            ...
            <div class="flex items-center gap-2 text-sm text-muted-foreground">
                <svg xmlns="http://www.w3.org/2000/svg"
                    width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                    class="lucide lucide-users w-4 h-4 flex-shrink-0">
        ...
        <div class="pt-2 border-t border-border border-gray-100 flex items-center justify-between">
            <div>
                ...
                @else
                    ...
                    <span class="text-lg font-medium text-foreground">KES {{ number_format($lowestPrice) }}</span>
                @endif
            </div>

             <a href="{{ route('events.show', $event->slug) }}" class="rounded-lg bg-indigo-600 px-3 py-1.5 text-xs font-semibold text-white transition-colors hover:bg-indigo-700">
                Get Tickets
            </a>
        </div>
    </div>
