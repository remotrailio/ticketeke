            ...
            <div class="lg:col-span-2">
                ...
                <div class="mt-8 space-y-4">
                    <div class="flex items-start gap-3 text-sm text-gray-700">
                        <svg class="mt-0.5 h-5 w-5 shrink-0 text-indigo-500" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    @if ($event->is_online)
                        <div class="flex items-center gap-3 text-sm text-gray-700">
                            <svg class="h-5 w-5 shrink-0 text-indigo-500" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                @if ($event->organizer)
                    <div class="mt-10 rounded-xl border border-gray-100 bg-gray-50 p-5 flex items-center gap-4">
                        ...
                        @else
                            <div
                                class="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-indigo-100 text-indigo-600 font-bold text-lg">
