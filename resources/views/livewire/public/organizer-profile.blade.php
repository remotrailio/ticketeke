<div>
    ...
    @php
        $bannerUrl = $organizer->banner
            ...
            : null;
    @endphp
    <div class="relative h-56 w-full overflow-hidden bg-indigo-700 sm:h-64">
        @if($bannerUrl)
        ...
        <div class="relative -mt-16 mb-8 flex items-end gap-5">
            <div class="shrink-0">
                @if($organizer->logo_url)
                    <img src="{{ $organizer->logo_url }}" alt="{{ $organizer->display_name }}"
                         class="h-28 w-28 rounded-xl border-4 border-white object-cover shadow-md">
                @else
                    <div class="flex h-28 w-28 items-center justify-center rounded-xl border-4 border-white bg-indigo-100 text-3xl font-bold text-indigo-600 shadow-md">
            ...
            <div class="pb-2">
                ...
                <a href="{{ $organizer->website }}" target="_blank" rel="noopener"
                   class="mt-1 inline-flex items-center gap-1 text-sm text-indigo-600 hover:underline">
